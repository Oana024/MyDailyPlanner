    ...
    return (
        <div className="friend-container">
                                            ...
                                            <div className="nearby-user">
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-1 col-sm-1">
                                                        <button className="btn btn-primary pull-right" onClick={() => openModal(friend.id)}>Invite
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                ...
                </div>
                {
                    tab === 'friends' ? (
                                    ...
                                    <div className="card-header">
                                        <div className="input-group mb-sm-2">
                                            <input type="text" className="form-control" placeholder="User email"
                                                   aria-label="User email" aria-describedby="basic-addon2" value={email}
                                                   onChange={handleChange} onKeyPress={handleKeypress}/>
                                            <div className="input-group-append">
                                                {/*<a className="btn"*/}
                                                {/*        onClick={() => searchForEmail()}>*/}
                                                    <Search onClick={() => searchForEmail()} style={{marginLeft: "4px", marginTop:"5px"}}></Search>
                                                {/*</a>*/}
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div>
                            <div className="container" style={{width: "70%"}}>
                                <div className="card">
                                    <div className="card-header" style={{textAlign: "center", alignContent:"center"}}>
                                            ...
                                            pendingRequests ? (
                                                pendingRequests.map((task, index) => (
                                                    <div key={index} className="card" style={{width: "80%"}}>
                                                        <div className="card-header" style={{fontWeight: "bold", fontSize: "20px", backgroundColor: task.priority}}>
                                                            {task.title}
                                                            <div className="buttons">
                                                                <button className="btn btn">
                                                                    <CheckSquareFill className="btn-icon-task" style={{color: "#378d2a"}}
                                                                     onClick={() => acceptInvite(task.id)} ></CheckSquareFill>
                                                                </button>
                                                                <button className="btn btn">
                                                                    <XSquareFill className="btn-icon-task" style={{color: "#fa0808"}}
                                                        ...
                                                        <div className="card-footer" style={{fontWeight: "bold", textAlign: "center"}}>
                                                           Date: {task.date}
                                                        </div>
                                                    </div>
                                                ))
            ...
            <Modal isOpen={modalIsOpen} onRequestClose={closeModal} ariaHideApp={false}>
                ...
                <button className="btn btn-primary" onClick={inviteFriend}>Add</button>
